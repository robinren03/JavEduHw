...
//        }
    ...
    void updateData(Integer x)
    {
        ...
        {
            Toast.makeText(WrongExerciseSet.this, "好像断网了，请检查您的网络设置", Toast.LENGTH_SHORT).show();
        }
        else
        {
            questionList.clear();
            ...
            {
                e.printStackTrace();
                Toast.makeText(WrongExerciseSet.this, "抱歉，服务器好像出了点问题，请稍后重试", Toast.LENGTH_SHORT).show();
            }
